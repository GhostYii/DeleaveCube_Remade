...
public static class INI
{
    ...
    /// 配置文件存储文件夹路径
    /// </summary>
    public static readonly string IniSaveDirectory = UnityEngine.Application.dataPath;
    //. Path.Combine(UnityEngine.Application.dataPath, "Profiles");
        
    /// <summary>
    /// 配置文件存储路径
    /// </summary>
    public static readonly string IniSavePath = Path.Combine(IniSaveDirectory, "config.ini");
